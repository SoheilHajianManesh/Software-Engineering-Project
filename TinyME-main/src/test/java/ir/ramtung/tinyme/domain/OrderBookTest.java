...
class OrderBookTest {
    ...
    void finds_the_first_order_by_id() {
        assertThat(security.getOrderBook().findByOrderIdInActiveQueue(Side.BUY, 1))
                .isEqualTo(orders.get(0));
    }

    @Test
    void fails_to_find_the_first_order_by_id_in_the_wrong_queue() {
        assertThat(security.getOrderBook().findByOrderIdInActiveQueue(Side.SELL, 1)).isNull();
    }

    @Test
    void finds_some_order_in_the_middle_by_id() {
        assertThat(security.getOrderBook().findByOrderIdInActiveQueue(Side.BUY, 3))
                .isEqualTo(orders.get(2));
    }

    @Test
    void finds_the_last_order_by_id() {
        assertThat(security.getOrderBook().findByOrderIdInActiveQueue(Side.SELL, 10))
    ...
    void removes_the_first_order_by_id() {
        ...
        orderBook.removeByOrderIdFromActiveQueue(Side.BUY, 1);
    ...
    void fails_to_remove_the_first_order_by_id_in_the_wrong_queue() {
        OrderBook orderBook = security.getOrderBook();
        orderBook.removeByOrderIdFromActiveQueue(Side.SELL, 1);
    ...
    void removes_the_last_order_by_id() {
        OrderBook orderBook = security.getOrderBook();
        orderBook.removeByOrderIdFromActiveQueue(Side.SELL, 10);
